...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //if (m_JoystickElevationAndTurning.Horizontal >= 0.4f)
        //{
        //    Vector3 eulerRotation = transform.rotation.eulerAngles;
        //    eulerRotation += Vector3.up * (m_RotationMultiplier * Time.deltaTime);
            
        //    transform.localRotation = Quaternion.Euler(eulerRotation);
        //}
        //else if (m_JoystickElevationAndTurning.Horizontal <= -0.4f)
        //{
        //    Vector3 eulerRotation = transform.rotation.eulerAngles;
        //    eulerRotation += Vector3.down * (m_RotationMultiplier * Time.deltaTime);
